...
export const sportsList: Sport[] = [
    ...
    { id: 'football', name: 'Футбол', icon: 'Goal', category: 'Командный' },
    { id: 'basketball', name: 'Баскетбол', icon: 'Basketball', category: 'Командный' },
    { id: 'volleyball', name: 'Волейбол', icon: 'Volleyball', category: 'Командный' },
    { id: 'rugby', name: 'Регби', icon: 'Egg', category: 'Командный' },
    { id: 'handball', name: 'Гандбол', icon: 'Hand', category: 'Командный' },
    { id: 'hockey', name: 'Хоккей', icon: 'Hockey', category: 'Командный' },
    { id: 'american_football', name: 'Американский футбол', icon: 'Signal', category: 'Командный' },
    ...
    { id: 'futsal', name: 'Мини-футбол', icon: 'Goal', category: 'Командный' },
    ...
    { id: 'tennis', name: 'Теннис', icon: 'Racquet', category: 'Некомандный' },
    ...
    { id: 'chess', name: 'Шахматы', icon: 'ChessRook', category: 'Некомандный' },
    ...
    { id: 'golf', name: 'Гольф', icon: 'GolfClub', category: 'Некомандный' },
