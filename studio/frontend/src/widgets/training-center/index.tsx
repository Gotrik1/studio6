...
export function TrainingCenterPage() {
    ...
    const planningLinks = [
        { href: "/training/programs", icon: ListChecks, label: "Программы тренировок" },
        { href: "/training/exercises", icon: Dumbbell, label: "Каталог упражнений" },
    ...
    const gamesLinks = [
        ...
        { onClick: () => setIsProposeTrainingOpen(true), icon: Users, label: "Предложить тренировку" },
        ...
        <>
            <div className="space-y-8 opacity-0 animate-fade-in-up">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 items-start">
                    <FeatureCard title="Планирование" description="Создавайте программы, ведите дневник и планируйте свой календарь." icon={Calendar}>
                        {planningLinks.map(link => <FeatureLink key={link.label} {...link} />)}
                    </FeatureCard>
                    
                    <FeatureCard title="Игры и Соревнования" description="Находите партнеров, планируйте матчи и бросайте вызовы." icon={Swords}>
                    ...
                    <FeatureCard title="Сообщество" description="Ищите игроков и тренеров, изучайте дисциплины и следите за лидерами." icon={Users2}>
                         {communityLinks.map(link => <FeatureLink key={link.label} {...link} />)}
                    </FeatureCard>
                </div>
            </div>
