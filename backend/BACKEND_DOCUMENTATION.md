...
| **Игровая телеметрия**           | **Kafka**    | **Планируется.** Для сбора потока событий во время матча. Это позволит в будущем строить аналитику в реальном времени и детальные повторы.                                                                                       |
