...
export type GenerateMatchPostInput = z.infer<
  typeof GenerateMatchPostInputSchema
>;
...
export type GenerateMatchPostOutput = z.infer<
  typeof GenerateMatchPostOutputSchema
>;
