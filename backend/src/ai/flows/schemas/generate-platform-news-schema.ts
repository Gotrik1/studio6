...
export const NewsItemSchema = z.object({
  ...
  category: z
    .enum(["match", "team", "player", "platform"])
    .describe("The category of the news."),
  href: z
    .string()
    .describe(
      "A relevant link for the news item, e.g., a team or player profile URL.",
    ),
});
...
export const GeneratePlatformNewsOutputSchema = z.object({
  news: z
    ...
    .describe("An array of 3-4 news items about recent platform activity."),
});
export type GeneratePlatformNewsOutput = z.infer<
  typeof GeneratePlatformNewsOutputSchema
>;
...
export const NewsWithAudioSchema = z.object({
  ...
  audioDataUri: z
    .string()
    .optional()
    .describe("The generated audio news digest as a data URI."),
});
