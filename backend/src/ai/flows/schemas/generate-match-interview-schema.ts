...
export type GenerateMatchInterviewInput = z.infer<
  typeof GenerateMatchInterviewInputSchema
>;

export const GenerateMatchInterviewOutputSchema = z.object({
  audioDataUri: z
    .string()
    .describe("The generated audio interview as a data URI in WAV format."),
  script: z.string().describe("The script of the interview."),
});
export type GenerateMatchInterviewOutput = z.infer<
  typeof GenerateMatchInterviewOutputSchema
>;
