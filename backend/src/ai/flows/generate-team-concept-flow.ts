...
import { z } from "zod";
import {
  GenerateTeamConceptInputSchema,
  GenerateTeamConceptOutputSchema,
} from "./schemas/generate-team-concept-schema";
import type {
  GenerateTeamConceptInput,
  GenerateTeamConceptOutput,
} from "./schemas/generate-team-concept-schema";
...
const generateTeamDetailsPrompt = ai.definePrompt({
  ...
  output: {
    schema: z.object({
      name: z
        .string()
        .describe("A creative and cool name for the esports team, in Russian."),
      motto: z
        .string()
        .describe("An inspiring or witty motto for the team, in Russian."),
      description: z
        .string()
        .describe(
          "A short, epic and engaging description for their team profile page, in Russian (2-3 sentences).",
        ),
    }),
  },
