...
const generateTournamentDetailsPrompt = ai.definePrompt({
    ...
    output: { schema: z.object({
        ...
        game: z.string().describe('The game or sport for the tournament, inferred from the prompt. E.g., "Valorant", "Футбол".'),
        type: z.enum(['team', 'individual']).describe('The tournament type, inferred from the prompt.'),
        format: z.enum(['single_elimination', 'round_robin', 'groups']).describe('The tournament format, inferred from the prompt.'),
