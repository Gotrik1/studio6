...
import {
  GeneratePromotionWizardInputSchema,
  GeneratePromotionWizardOutputSchema,
} from "./schemas/generate-promotion-wizard-schema";
import type {
  GeneratePromotionWizardInput,
  GeneratePromotionWizardOutput,
} from "./schemas/generate-promotion-wizard-schema";
...
export async function generatePromotionWizard(
  ...
  return generatePromotionWizardFlow_Backend(input);
}

const generatePromotionWizardFlow_Backend = ai.defineFlow(
  {
    name: "generatePromotionWizardFlow_Backend",
