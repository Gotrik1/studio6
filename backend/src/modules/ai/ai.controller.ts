...
export class AiController {
  ...
  async generateTeamAvatar(
    @Body() generateTeamAvatarDto: GenerateTeamAvatarDto,
  ...
  async generatePromotionDetails(
    @Body() generatePromotionDetailsDto: GeneratePromotionDetailsDto,
  ...
  async generatePromotionImage(
    @Body() generatePromotionImageDto: GeneratePromotionImageDto,
  ): Promise<GeneratePromotionImageOutput> {
    return this.aiService.generatePromotionImage(
      generatePromotionImageDto.prompt,
    );
  }

  @Post("promotions/wizard")
  @ApiOperation({
    summary: "Создает концепцию промо-акции и сразу сохраняет ее",
  })
  ...
  @ApiOperation({
    summary:
      "Сгенерировать полную концепцию команды (название, девиз, описание, аватар).",
  })
  @ApiBody({ type: GenerateTeamConceptDto })
  @ApiResponse({
    status: 200,
    description: "Концепция команды успешно сгенерирована.",
    type: GenerateTeamConceptDto,
  })
  ...
  async generateProfileBanner(
    ...
    return this.aiService.generateProfileBanner(
      generateProfileBannerDto.prompt,
    );
  }
  ...
  async analyzeEsportsPerformance(
    ...
    return this.aiService.analyzeEsportsPerformance(
      analyzeEsportsPerformanceDto,
    );
  }
  ...
  async generatePlaygroundSummary(
    ...
    return this.aiService.generatePlaygroundSummary(
      generatePlaygroundSummaryDto,
    );
  }
  ...
  async generatePlaygroundWorkout(
    ...
    return this.aiService.generatePlaygroundWorkout(
      generatePlaygroundWorkoutDto,
    );
  }
  ...
  async generatePlaygroundChallenge(
    ...
    return this.aiService.generatePlaygroundChallenge(
      generatePlaygroundChallengeDto,
    );
  }
  ...
  async generateMatchPost(
    @Body() generateMatchPostDto: GenerateMatchPostDto,
  ...
  async analyzeHolisticPerformance(
    ...
    return this.aiService.analyzeHolisticPerformance(
      analyzeHolisticPerformanceDto,
    );
  }
  ...
  async generateSportSummary(
    @Body() generateSportSummaryDto: GenerateSportSummaryDto,
  ...
  async generateTournamentSummary(
    ...
    return this.aiService.generateTournamentSummary(
      generateTournamentSummaryDto,
    );
  }
