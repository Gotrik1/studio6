      ...
      data: [
        {
          ...
          description:
            "Разблокируйте эксклюзивные функции: глубокий AI-анализ, кастомные аватары и значок PRO.",
          price: 500,
        ...
        },
        {
          ...
          description:
            "Удвойте получаемые очки рейтинга за победы в течение одной недели.",
          price: 350,
          image: "https://placehold.co/600x400.png",
        ...
        },
        {
          ...
          description:
            "Покажите всем свой огонь с этой эксклюзивной анимированной рамкой для аватара.",
          price: 250,
          image: "https://placehold.co/600x400.png",
        ...
        },
        {
          name: "Смена никнейма",
          description:
            "Измените ваш никнейм на платформе. Доступно раз в 30 дней.",
          price: 150,
          image: "https://placehold.co/600x400.png",
