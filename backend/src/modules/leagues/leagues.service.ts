  ...
  async seedLeagues() {
    ...
    const league = await this.prisma.league.create({
      data: {
        ...
        description:
          "Главная лига по дворовому футболу 5x5 на платформе. Лучшие команды соревнуются за звание чемпиона сезона.",
        game: "Футбол",
    ...
    const matchesData = [
      {
        ...
        team1Score: 5,
        team2Score: 2,
        scheduledAt: new Date("2024-08-03T18:00:00Z"),
      ...
      },
      {
        ...
        team1Score: 2,
        team2Score: 1,
        scheduledAt: new Date("2024-08-03T19:00:00Z"),
        status: "FINISHED" as const,
      },
      {
        team1Id: teams[0].id,
        ...
        team1Score: 3,
        team2Score: 1,
        scheduledAt: new Date("2024-08-10T18:00:00Z"),
        status: "FINISHED" as const,
      },
      {
        team1Id: teams[2].id,
        ...
        team1Score: 4,
        team2Score: 2,
        scheduledAt: new Date("2024-08-10T19:00:00Z"),
        status: "FINISHED" as const,
      },
    ];
