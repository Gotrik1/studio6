...
export const trainingPrograms: TrainingProgram[] = [
  {
    ...
    description:
      "Проверенная временем программа для набора мышечной массы и проработки всех основных мышечных групп.",
    goal: "Набор массы",
    daysPerWeek: 3,
    splitType: "Split",
    author: "ProDvor Team",
  ...
  },
  {
    ...
    description:
      "Специализированная программа с акцентом на развитие ягодичных мышц и ног для создания гармоничной фигуры.",
    goal: "Рельеф",
    daysPerWeek: 4,
    splitType: "Split",
    author: "Coach Anna",
  ...
  },
  {
    ...
    name: "Пауэр-сплит",
    description:
      "Программа, нацеленная на максимальное увеличение силовых показателей в базовых движениях.",
    goal: "Сила",
    daysPerWeek: 4,
  ...
  },
  {
    ...
    description:
      "Идеальная программа для начинающих, чтобы укрепить всё тело и подготовиться к более серьезным нагрузкам.",
    goal: "Набор массы",
    daysPerWeek: 3,
    splitType: "Full-body",
    author: "ProDvor Team",
  ...
  },
  {
    ...
    description:
      "Индивидуальный план, сгенерированный AI, который адаптируется под ваш график и цели.",
    goal: "Снижение веса",
    daysPerWeek: 2,
    splitType: "Full-body",
    author: "ProDvor AI",
  ...
  },
  {
    ...
    description:
      "Высокоинтенсивная интервальная тренировка для максимального расхода калорий и ускорения метаболизма.",
    goal: "Снижение веса",
    daysPerWeek: 3,
    splitType: "Full-body",
  ...
  },
  {
    ...
    description:
      "Программа для развития силы и выносливости с использованием только собственного веса. Идеально для дома или улицы.",
    goal: "Сила",
    daysPerWeek: 4,
    splitType: "Full-body",
