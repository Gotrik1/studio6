  ...
  async seedCoaches() {
    ...
    await this.prisma.coachProfile.create({
        data: {
            ...
            description: 'Бывший профессиональный игрок, специализируюсь на стратегическом анализе и индивидуальной подготовке снайперов. Помогу улучшить понимание игры, принятие решений и механику стрельбы.',
