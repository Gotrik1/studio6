...
export function CoachCenterPage() {
    ...
    // Augment summary data from backend with mock stats for full UI compatibility.
    const coachedPlayers: CoachedPlayer[] = (coachData.coaching || []).map(augmentCoachedPlayer);
