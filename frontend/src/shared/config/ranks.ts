export const RANKS = [
  ...
  },
  {
    ...
    minPoints: 501,
    maxPoints: 1000,
    title: "уже не стыдно (но фото в зал ещё не выкладываю)",
  ...
  },
  {
    ...
    maxPoints: 8000,
    title:
      "мастерство как философия (и да, он всё ещё злится, когда проигрывает)",
    color: "text-pink-500",
  },
  {
    name: "Неоспоримый",
  ...
  },
  {
    ...
    maxPoints: Infinity,
    title:
      "абсолютный финал (спортсменов, рекордов и вашей веры в справедливость)",
