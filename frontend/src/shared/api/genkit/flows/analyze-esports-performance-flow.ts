...
export async function analyzeEsportsPerformance(input: AnalyzeEsportsPerformanceInput): Promise<AnalyzeEsportsPerformanceOutput> {
  return analyzeEsportsPerformanceFlow(input);
}

const prompt = ai.definePrompt({
  name: 'analyzeEsportsPerformancePrompt',
...
const analyzeEsportsPerformanceFlow = ai.defineFlow(
  {
    name: 'analyzeEsportsPerformanceFlow',
