...
export async function generatePlaygroundDrill(input: GeneratePlaygroundDrillInput): Promise<GeneratePlaygroundDrillOutput> {
  return generatePlaygroundDrillFlow(input);
}

const prompt = ai.definePrompt({
  name: 'generatePlaygroundDrillPrompt',
...
const generatePlaygroundDrillFlow = ai.defineFlow(
  {
    name: 'generatePlaygroundDrillFlow',
