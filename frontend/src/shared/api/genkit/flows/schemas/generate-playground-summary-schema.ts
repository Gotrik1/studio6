...
export type GeneratePlaygroundSummaryInput = z.infer<typeof GeneratePlaygroundSummaryInputSchema>;

export const GeneratePlaygroundSummaryOutputSchema = z.object({
  summary: z.string().describe('A short, helpful summary for players.'),
});
export type GeneratePlaygroundSummaryOutput = z.infer<typeof GeneratePlaygroundSummaryOutputSchema>;
