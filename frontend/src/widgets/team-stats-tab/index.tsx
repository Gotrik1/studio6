            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardTitle className="font-headline text-4xl">{totalMatches}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                     <CardHeader>
                        <CardDescription>Командный Winrate</CardDescription>
                        <CardTitle className="font-headline text-4xl">{winrate.toFixed(1)}%</CardTitle>
                    </CardHeader>
                </Card>
            </div>
                ...
                <Card>
                 ...
                 <Card>
                    <CardHeader>
                        ...
                        <CardTitle className="font-headline text-3xl">{team.membersCount}</CardTitle>
                    </CardHeader>
                </Card>
            </div>
