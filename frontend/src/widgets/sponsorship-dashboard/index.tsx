...
export function SponsorshipDashboard({
  ...
  data: SponsorshipDashboardData | null;
}) {
  ...
  return (
    <div className="space-y-6 opacity-0 animate-fade-in-up">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          title="Спонсируемых команд"
          value={String(sponsoredTeams.length)}
          icon={Users}
        />
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <UserSearch /> Команды в поиске спонсоров
              </CardTitle>
              <CardDescription>
                Список команд, которые активно ищут поддержку.
              </CardDescription>
            </CardHeader>
              ...
              {teamsSeekingSponsorship.map((team) => (
                <Card key={team.slug} className="p-4">
                  <div className="flex justify-between items-start">
                    ...
                    <Button size="sm" onClick={() => handleContact(team.name)}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Image
                          ...
                          data-ai-hint={team.logoHint || "team logo"}
                        />
