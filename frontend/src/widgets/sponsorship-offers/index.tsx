...
import {
  getSponsorshipOffers,
  respondToSponsorshipOffer,
  type SponsorshipOffer,
} from "@/entities/sponsorship/api/offers";
  ...
  const fetchOffers = useCallback(async () => {
    ...
    if (result.success && result.data) {
      ...
      toast({
        variant: "destructive",
        title: "Ошибка",
        description: "Не удалось загрузить спонсорские предложения.",
      });
    }
    setIsLoading(false);
  }, [teamId, toast]);
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        toast({
          ...
          title: "Ошибка",
          description:
            result.error || "Не удалось обновить статус предложения.",
        });
      }
    });
  };
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Предложения от компаний, заинтересованных в вашей команде.
        </CardDescription>
      </CardHeader>
              ...
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-4">
                  <Image
                    ...
                    data-ai-hint={offer.sponsor.logoHint}
                  />
                  <div>
