    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Помогите нам сделать платформу лучше. Все жалобы рассматриваются модераторами.
          </DialogDescription>
        </DialogHeader>
        <div className="py-4 space-y-4">
          ...
          <div>
            ...
            <Textarea id="details" value={details} onChange={(e) => setDetails(e.target.value)} placeholder="Опишите ситуацию как можно подробнее..." />
          </div>
        </div>
        <DialogFooter>
