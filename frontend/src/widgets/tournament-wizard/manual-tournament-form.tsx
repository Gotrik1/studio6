...
} from "@/entities/tournament/api/tournaments";
...
const tournamentSchema = z.object({
  ...
  format: z.enum(["single_elimination", "round_robin", "groups"], {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    if (
      ...
      toast({
        ...
        description:
          (result as { error: string }).error || "Не удалось создать турнир.",
      });
    }
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardHeader>
              ...
              <CardDescription>
                Заполните все необходимые поля для создания нового турнира.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Например, ProDvor Summer Cup"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Краткое описание (необязательно)</FormLabel>
                      <FormControl>
                        <Textarea
                          placeholder="Для кого этот турнир, какие его цели?"
                          {...field}
                          value={field.value ?? ""}
                        />
                      </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue placeholder="Командный или индивидуальный" />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
              ...
              <div className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Например, Любительский"
                            {...field}
                          />
                        </FormControl>
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Онлайн / Название площадки"
                            {...field}
                          />
                        </FormControl>
                      </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Призовой фонд (необязательно)</FormLabel>
                      <FormControl>
                        <Input
                          placeholder="Например, 50,000 PD + девайсы от спонсора"
                          {...field}
                          value={field.value ?? ""}
                        />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Правила (необязательно)</FormLabel>
                      <FormControl>
                        <Textarea
                          placeholder="Опишите основные правила и регламент турнира..."
                          {...field}
                          value={field.value ?? ""}
                        />
                      </FormControl>
