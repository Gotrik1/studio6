...
} from "@/shared/api/genkit/flows/generate-social-media-post-flow";
...
export function AiSocialMediaPostGenerator() {
  ...
  const [result, setResult] = useState<GenerateSocialMediaPostOutput | null>(
    null,
  );
  const [postType, setPostType] =
    useState<GenerateSocialMediaPostInput["postType"]>("match_announcement");
  const [context, setContext] = useState(
    "Предстоящий матч против 'Соколы' в 20:00. Это будет битва за первое место в лиге!",
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Создавайте контент для социальных сетей вашей команды.
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select
              value={postType}
              onValueChange={(v) =>
                setPostType(v as GenerateSocialMediaPostInput["postType"])
              }
            >
              <SelectTrigger>
                <SelectValue />
