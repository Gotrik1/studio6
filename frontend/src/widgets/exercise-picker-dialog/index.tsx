...
export function ExercisePickerDialog({
  ...
  const filteredExercises = useMemo(() => {
    return allExercises.filter((exercise) => {
      ...
      const matchesMuscle =
        muscleFilter === "Все" || exercise.category === muscleFilter;
      const matchesEquipment =
        equipmentFilter === "Все" || exercise.equipment === equipmentFilter;
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Выберите одно или несколько упражнений для добавления в
            тренировочный день.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex flex-wrap gap-2">
              <span className="text-sm font-medium p-2 self-center">
                Категория:
              </span>
