                ...
                <ScrollArea className="w-full h-[60vh]">
                    <div className="grid grid-cols-[auto_repeat(7,1fr)] gap-px bg-border">
                        ...
                        {/* Main Grid for bookings and empty cells */}
                            ...
                            {days.map((day) => (
                                <div key={day.toISOString()} className="relative col-span-1 grid grid-rows-30">
                                                ...
                                                <TooltipProvider key={booking.id}>
                                                    <Tooltip>
                                                        <TooltipTrigger asChild>
                                                            ...
                                                            >
                                                                <p className="text-xs font-bold text-primary truncate">{booking.creator.name}</p>
                                                            </div>
                                                        </TooltipTrigger>
                                                        <TooltipContent>
                                                            ...
                                                            <p className="text-xs text-muted-foreground mt-1">{booking.comment}</p>
                                                        </TooltipContent>
                                                    </Tooltip>
                                                </TooltipProvider>
                                            );
