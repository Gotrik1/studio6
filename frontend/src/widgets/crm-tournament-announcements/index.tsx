...
import {
  createAnnouncement,
  getAnnouncements,
} from "@/entities/tournament/api/announcements";
...
export function CrmTournamentAnnouncements({
  tournamentId,
}: CrmTournamentAnnouncementsProps) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <Card className="lg:col-span-1">
        <CardHeader>
          ...
          <CardDescription>
            Создайте и отправьте объявление всем участникам турнира.
          </CardDescription>
        </CardHeader>
                  ...
                  announcements.map((ann) => (
                    <TableRow key={ann.id}>
                      ...
                      <TableCell className="hidden md:table-cell text-muted-foreground text-xs">
                        {format(new Date(ann.createdAt), "d MMMM yyyy, HH:mm", {
                          locale: ru,
                        })}
                      </TableCell>
