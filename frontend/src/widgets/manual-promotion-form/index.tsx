        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <CardHeader>
              ...
              <CardDescription>
                Заполните все необходимые поля для создания новой акции или
                конкурса.
              </CardDescription>
            </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Например, Конкурс на лучший игровой момент"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Подробно опишите условия и правила участия"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Например, 10,000 PD + игровая мышь"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue placeholder="Выберите спонсора из списка" />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
