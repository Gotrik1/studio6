...
import {
  getPlaygroundReviewSummary,
  type ReviewSummary,
} from "@/entities/playground/api/review-summary";

interface PlaygroundReviewSummaryProps {
  playgroundId: string;
}

export function PlaygroundReviewSummary({
  playgroundId,
}: PlaygroundReviewSummaryProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Краткая выжимка из всех отзывов игроков.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold text-sm mb-2 flex items-center gap-1.5 text-green-600">
            ...
            <div>
              <h4 className="font-semibold text-sm mb-2 flex items-center gap-1.5 text-red-600">
