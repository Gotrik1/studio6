...
} from "@/shared/api/genkit/flows/generate-playground-tactic-flow";
...
export function AiPlaygroundTactic({ playground }: AiPlaygroundTacticProps) {
  const [result, setResult] = useState<GeneratePlaygroundTacticOutput | null>(
    null,
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Сгенерируйте тактическую схему для вашей команды с учетом особенностей
          этой площадки.
        </CardDescription>
      </CardHeader>
      <CardContent>
