                    ...
                    <TableBody>
                        {matches.map(match => (
                            <TableRow key={match.id}>
                                ...
                                <TableCell className="text-right text-muted-foreground text-xs">{match.timestamp ? formatDistanceToNow(new Date(match.timestamp), { addSuffix: true, locale: ru }) : 'N/A'}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
