...
} from "@/shared/api/genkit/flows/generate-playground-workout-flow";
import {
  Table,
  TableBody,
  TableCell,
...
export function PlaygroundWorkoutGenerator({
  playground,
}: PlaygroundWorkoutGeneratorProps) {
  const [result, setResult] = useState<GeneratePlaygroundWorkoutOutput | null>(
    null,
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Сгенерируйте тренировку или занятие, подходящее для этого места.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isLoading && (
