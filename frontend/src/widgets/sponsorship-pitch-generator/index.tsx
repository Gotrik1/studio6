...
} from "@/shared/api/genkit/flows/generate-sponsorship-pitch";
...
const mockTeamInfo = {
  ...
  goals:
    "Ищем партнеров для выхода на международную арену, финансирование поездок на LAN-турниры, брендированная форма.",
  audience:
    "50,000+ подписчиков в социальных сетях, средний возраст аудитории 16-24.",
};
...
export function SponsorshipPitchGenerator() {
  ...
  const [result, setResult] = useState<GenerateSponsorshipPitchOutput | null>(
    null,
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Создайте профессиональное спонсорское предложение для вашей команды в
          один клик на основе данных вашего профиля.
        </CardDescription>
      </CardHeader>
