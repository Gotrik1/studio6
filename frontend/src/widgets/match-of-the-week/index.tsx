  ...
  useEffect(() => {
    const fetchHighlight = async () => {
      ...
      try {
        ...
        const scoreParts = matchData.score
          .split("-")
  ...
  return (
    <Card className="overflow-hidden">
      <div className="relative h-40">
        <Image
          src={matchPost.imageDataUri}
          alt="Матч недели"
          fill
          className="object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
        <CardTitle className="absolute bottom-2 left-4 text-white font-headline text-xl shadow-lg">
          Матч недели
        </CardTitle>
      </div>
      <CardHeader>
        <CardDescription>
          {matchDetails.tournament || "Товарищеский матч"}
        </CardDescription>
