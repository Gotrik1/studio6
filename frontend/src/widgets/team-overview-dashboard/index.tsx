...
export function TeamOverviewDashboard({
  ...
  const winrate =
    totalMatches > 0 ? ((team.wins / totalMatches) * 100).toFixed(1) : "0.0";
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <Avatar>
                    <AvatarImage
                      src={upcomingMatch.team1.logo}
                      data-ai-hint={upcomingMatch.team1.logoHint}
                    />
                    <AvatarFallback>
                      {upcomingMatch.team1.name.charAt(0)}
                    </AvatarFallback>
                  </Avatar>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Avatar>
                    <AvatarImage
                      src={upcomingMatch.team2.logo}
                      data-ai-hint={upcomingMatch.team2.logoHint}
                    />
                    <AvatarFallback>
                      {upcomingMatch.team2.name.charAt(0)}
                    </AvatarFallback>
                  </Avatar>
                </div>
              </div>
