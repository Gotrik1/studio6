...
export function AddFoodDialog({
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      toast({
        title: "Добавлено!",
        description: `${foodItem.name} (${data.grams}г) добавлен(о) в дневник.`,
      });
      onOpenChange(false);
    } catch (e) {
      console.error(e);
      toast({
        variant: "destructive",
        title: "Ошибка",
        description: "Не удалось добавить запись в дневник.",
      });
    }
  };
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <DialogHeader>
              ...
              <DialogDescription>
                Укажите вес и прием пищи, чтобы добавить продукт в дневник.
              </DialogDescription>
            </DialogHeader>
