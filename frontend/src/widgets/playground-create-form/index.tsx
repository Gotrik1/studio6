  ...
  const onSubmit = async (data: FormValues) => {
    ...
    if (result.success) {
      const toastDescription =
        "Место добавлено и отправлено на модерацию! Вы получили 1 месяц PRO-подписки!";
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardHeader>
            ...
            <CardDescription>
              Добавьте новое место. Оно появится на карте и будет ожидать
              проверки модератором. За каждое уникальное место вы получите 1
              месяц PRO-подписки!
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Например, Коробка за домом или Фитнес-клуб 'Атлет'"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Начните вводить адрес, а затем уточните положение на карте.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                onClick={() =>
                  toast({
                    title: "Карта будет здесь!",
                    description:
                      "В продакшен-версии здесь будет интерактивная карта для установки метки.",
                  })
                }
              >
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Теннисный корт">
                          Теннисный корт
                        </SelectItem>
                        <SelectItem value="Лыжная трасса">
                          Лыжная трасса
                        </SelectItem>
                        <SelectItem value="Биатлонный комплекс">
                          Биатлонный комплекс
                        </SelectItem>
                        <SelectItem value="Каток">Каток</SelectItem>
                        <SelectItem value="Сноуборд-парк">
                          Сноуборд-парк
                        </SelectItem>
                        <SelectItem value="Горнолыжный склон">
                          Горнолыжный склон
                        </SelectItem>
                        <SelectItem value="Стрельбище">Стрельбище</SelectItem>
                        <SelectItem value="Универсальная">
                          Универсальная
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Искусственный газон">
                          Искусственный газон
                        </SelectItem>
                        <SelectItem value="Профессиональный газон">
            ...
            <FormItem>
              ...
              <FormDescription>
                Рекомендуемый размер 1200x400. Будет отображаться на странице
                площадки.
              </FormDescription>
            </FormItem>
          </CardContent>
