    ...
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={data}>
        ...
        <XAxis 
            ...
            axisLine={false}
        />
        <YAxis domain={['dataMin - 1', 'dataMax + 1']} fontSize={12} tickLine={false} axisLine={false}/>
        <Tooltip 
        ...
        />
        <Line type="monotone" dataKey="value" name={metricLabel} stroke="hsl(var(--primary))" strokeWidth={2} activeDot={{ r: 8 }} connectNulls/>
      </LineChart>
    </ResponsiveContainer>
  );
}
