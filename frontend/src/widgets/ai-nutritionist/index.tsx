...
} from "@/shared/api/genkit/flows/generate-nutrition-plan-flow";
...
export function AiNutritionist() {
  ...
  const [result, setResult] = useState<GenerateNutritionPlanOutput | null>(
    null,
  );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Получите персональный план питания и рекомендации по калориям,
          основанные на ваших целях.
        </CardDescription>
      </CardHeader>
      <Form {...form}>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Ваша главная цель</FormLabel>
                    <Select
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Поддержание веса">
                          Поддержание веса
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="Низкий">
                          Низкий (офисная работа)
                        </SelectItem>
                        <SelectItem value="Средний">
                          Средний (3-5 тренировок/нед)
                        </SelectItem>
                        <SelectItem value="Высокий">
                          Высокий (6+ тренировок/нед)
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Предпочтения (необязательно)</FormLabel>
                    <FormControl>
                      <Input
                        placeholder="Например, вегетарианство, без лактозы"
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
          ...
          <div className="w-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="text-center">
                <CardHeader>
                  <CardTitle>{result.dailyCalories.toLocaleString()}</CardTitle>
                  <CardDescription>Ккал/день</CardDescription>
                </CardHeader>
              </Card>
              <Card className="text-center">
                <CardHeader>
                  <CardTitle>{result.macronutrients.protein}г</CardTitle>
                  <CardDescription>Белки</CardDescription>
                </CardHeader>
              </Card>
              <Card className="text-center">
                <CardHeader>
                  <CardTitle>{result.macronutrients.fat}г</CardTitle>
                  <CardDescription>Жиры</CardDescription>
                </CardHeader>
              </Card>
              <Card className="text-center">
                <CardHeader>
                  <CardTitle>{result.macronutrients.carbs}г</CardTitle>
                  ...
                  <Card key={meal.mealName}>
                    <CardHeader>
                      <CardTitle className="text-base">
                        {meal.mealName} (~{meal.calories} ккал)
                      </CardTitle>
