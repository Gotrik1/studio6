...
const CoachProfile = dynamic(
  () =>
    import("@/entities/user/ui/coach-profile").then((mod) => mod.CoachProfile),
  {
    loading: () => (
...
export default function CoachClient({
  ...
  return (
    <CoachProfile user={user} achievements={achievements} players={players} />
  );
}
