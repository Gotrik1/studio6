      ...
      <Tabs defaultValue="players">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="players">
            <Star className="mr-2 h-4 w-4" /> Рейтинг игроков
          </TabsTrigger>
          <TabsTrigger value="teams">
            <Gamepad2 className="mr-2 h-4 w-4" /> Рейтинг команд
          </TabsTrigger>
        </TabsList>
        <TabsContent value="players" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Рейтинг основан на очках, полученных в матчах и турнирах.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="teams" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Рейтинг основан на количестве побед и поражений.
              </CardDescription>
            </CardHeader>
            <CardContent>
