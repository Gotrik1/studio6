...
export function augmentCoachedPlayer(
  playerSummary: CoachedPlayerSummary,
): CoachedPlayer {
  ...
  return {
    ...
    matchHistory: ["W 13-8", "L 10-13", "W 13-2", "W 13-5"][
      Math.floor(Math.random() * 4)
    ],
    adherence:
      playerSummary.adherence ?? Math.floor(Math.random() * (98 - 75 + 1) + 75),
