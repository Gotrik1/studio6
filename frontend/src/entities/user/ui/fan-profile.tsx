...
const FanStatsTab = dynamic(
  () =>
    import("@/entities/user/ui/fan-profile-tabs/stats-tab").then(
      (mod) => mod.FanStatsTab,
    ),
  {
    loading: () => (
...
const FanAchievementsTab = dynamic(
  () =>
    import("@/entities/user/ui/fan-profile-tabs/achievements-tab").then(
      (mod) => mod.FanAchievementsTab,
    ),
  {
    loading: () => (
      <Card>
...
const FavoriteTeamsTab = dynamic(
  () =>
    import("@/entities/user/ui/fan-profile-tabs/favorite-teams-tab").then(
      (mod) => mod.FavoriteTeamsTab,
    ),
  {
    loading: () => (
      <Card>
      ...
      <Card className="overflow-hidden">
        <div className="relative aspect-[3/1] bg-muted/40">
          <Image
            ...
            data-ai-hint="stadium crowd cheering"
          />
