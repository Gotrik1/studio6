...
const ModeratorStatsTab = dynamic(
  () =>
    import("@/entities/user/ui/moderator-profile-tabs/stats-tab").then(
      (mod) => mod.ModeratorStatsTab,
    ),
  {
    loading: () => (
...
const ModeratorAchievementsTab = dynamic(
  () =>
    import("@/entities/user/ui/moderator-profile-tabs/achievements-tab").then(
      (mod) => mod.ModeratorAchievementsTab,
    ),
  {
    loading: () => (
      <Card>
