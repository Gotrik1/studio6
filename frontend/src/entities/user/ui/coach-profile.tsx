...
const CoachStatsTab = dynamic(
  () =>
    import("@/entities/user/ui/coach-profile-tabs/stats-tab").then(
      (mod) => mod.CoachStatsTab,
    ),
  {
    loading: () => (
...
const CoachAchievementsTab = dynamic(
  () =>
    import("@/entities/user/ui/coach-profile-tabs/achievements-tab").then(
      (mod) => mod.CoachAchievementsTab,
    ),
  {
    loading: () => (
      <Card>
...
const MyPlayersTab = dynamic(
  () =>
    import("@/entities/user/ui/coach-profile-tabs/my-players-tab").then(
      (mod) => mod.MyPlayersTab,
    ),
  {
    loading: () => (
      <Card>
...
const MyProgramsTab = dynamic(
  () =>
    import("@/entities/user/ui/coach-profile-tabs/my-programs-tab").then(
      (mod) => mod.MyProgramsTab,
    ),
  {
    loading: () => (
      <Card>
      ...
      <Card className="overflow-hidden">
        <div className="relative aspect-[3/1] bg-muted/40">
          <Image
            ...
            data-ai-hint="sports strategy playbook"
          />
