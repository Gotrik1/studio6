...
const ManagerStatsTab = dynamic(
  () =>
    import("@/entities/user/ui/manager-profile-tabs/stats-tab").then(
      (mod) => mod.ManagerStatsTab,
    ),
  {
    loading: () => (
...
const ManagedPlayersTab = dynamic(
  () =>
    import("@/entities/user/ui/manager-profile-tabs/managed-players-tab").then(
      (mod) => mod.ManagedPlayersTab,
    ),
  {
    loading: () => (
      <Card>
...
const ManagerAchievementsTab = dynamic(
  () =>
    import("@/entities/user/ui/manager-profile-tabs/achievements-tab").then(
      (mod) => mod.ManagerAchievementsTab,
    ),
  {
    loading: () => (
      <Card>
      ...
      <Card className="overflow-hidden">
        <div className="relative aspect-[3/1] bg-muted/40">
          <Image
            ...
            data-ai-hint="business cityscape"
          />
