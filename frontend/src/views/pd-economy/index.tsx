        ...
        <div className="space-y-6 opacity-0 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <ul className="space-y-3">
                            {earningRules.filter(r => r.editable === false).slice(0, 5).map(quest => {
                                return (
                                    <li key={quest.id} className="flex justify-between items-center text-sm p-2 rounded-md bg-muted/50">
                                        <span className={'text-muted-foreground'}>{quest.description}</span>
                                        <span className="font-bold text-green-500">+{quest.value} PD</span>
                                    </li>
                                )
                            })}
                        </ul>
