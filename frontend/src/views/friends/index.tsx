      ...
      <Card key={friend.id} className="p-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <Badge
              variant={friend.status === "Активен" ? "default" : "outline"}
            >
              {friend.status}
            </Badge>
          </div>
...
const RequestsList = ({
  ...
  data: FriendRequest[];
  onAction: (req: FriendRequest) => void;
  onAction2: (req: FriendRequest) => void;
}) => (
...
const SuggestionsList = ({
  ...
  onAction: (sug: FriendSuggestion) => void;
}) => (
  <div className="space-y-3">
    {data.map((suggestion) => (
      <Card
        ...
        <div className="flex items-center gap-4">
          <Avatar className="h-12 w-12">
            <AvatarImage
              ...
              alt={suggestion.name}
              data-ai-hint={suggestion.avatarHint}
            />
        ...
        <TabsContent value="requests" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Запросы на добавление в друзья от других игроков.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
        ...
        <TabsContent value="suggestions" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Игроки, которых вы можете знать.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
