  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Измените основную информацию о вашем аккаунте.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Например, Valorant или Футбол"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
...
const passwordFormSchema = z
  .object({
    currentPassword: z
      .string()
      .min(1, { message: "Текущий пароль не может быть пустым." }),
    newPassword: z
      .string()
      .min(8, {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Для вашей безопасности рекомендуется периодически менять пароль.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
