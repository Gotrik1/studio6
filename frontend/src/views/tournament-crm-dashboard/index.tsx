  ...
  return (
    <div className="space-y-6 opacity-0 animate-fade-in-up">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Создавайте, редактируйте и управляйте всеми вашими турнирами.
          </p>
        </div>
        <Button asChild>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        />
        <StatCard
          title="Общий призовой фонд"
          value="$135,000"
          description="Сумма по всем турнирам"
          icon={DollarSign}
        />
        <StatCard
          title="Требуют внимания"
          value="1"
          description="Турниры со спорными матчами"
          icon={ClipboardCheck}
        />
      </div>
                  ...
                  <TableRow key={tournament.id}>
                    ...
                    <TableCell className="text-right">
                      <Button asChild variant="outline" size="sm">
                        <Link
                          href={`/administration/tournament-crm/${tournament.id}`}
                        >
                          Управлять
                        </Link>
                      </Button>
