    ...
    <div className="space-y-6 opacity-0 animate-fade-in-up">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Участвуйте в сезонных лигах, сражайтесь за верхние строчки в таблице и
          докажите, что ваша команда — лучшая.
        </p>
      </div>
      <div className="space-y-6">
        {isLoading ? (
            ...
            >
              <Card className="overflow-hidden transition-all hover:shadow-lg hover:border-primary">
                <div className="relative h-48 w-full">
                  <Image
                    src={league.image || "https://placehold.co/2560x720.png"}
                    alt={league.name}
                    fill
                    className="object-cover"
                    data-ai-hint={league.imageHint || "league banner"}
                  />
          ...
          <Card className="text-center p-12">
            <p className="text-muted-foreground">
              На данный момент активных лиг нет.
            </p>
          </Card>
        )}
      </div>
