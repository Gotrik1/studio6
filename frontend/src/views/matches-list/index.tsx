...
export function MatchesListPage({ initialMatches }: MatchesListPageProps) {
  ...
  const handleMatchUpdate = async (result: MatchResult) => {
    const updateResult = await updateMatchScore(
                  ...
                  <TableRow key={match.id}>
                    <TableCell>
                      ...
                      >
                        ...
                        <span className="font-bold text-lg text-muted-foreground group-hover:text-primary transition-colors">
                          {match.score}
                        </span>
