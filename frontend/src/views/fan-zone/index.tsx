  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Ошибка",
        description: "Не удалось загрузить данные для фан-зоны.",
      });
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="space-y-6 opacity-0 animate-fade-in-up">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Место для самых преданных болельщиков. Голосуйте в опросах, участвуйте
          в конкурсах и следите за любимыми командами.
        </p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Участвуйте в конкурсах от наших партнеров и выигрывайте ценные
                призы!
              </CardDescription>
            </CardHeader>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Команды, за которыми следят больше всего.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ваше мнение важно для нас! Примите участие в еженедельном
                опросе.
              </CardDescription>
            </CardHeader>
            <CardContent>
