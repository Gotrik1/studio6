...
export function MedAccreditationPage() {
  ...
  const handleSubmit = () => {
    toast({
      ...
      description:
        "Ваша заявка на аккредитацию будет рассмотрена в ближайшее время.",
    });
  };
    ...
    <div className="space-y-6 opacity-0 animate-fade-in-up">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Подайте заявку, чтобы стать официальным медицинским партнером
          мероприятий на платформе ProDvor.
        </p>
      </div>
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Пожалуйста, предоставьте информацию о вашей организации и прикрепите
