...
} from "@/entities/team/api/get-team-dashboard";
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        toast({
          ...
          description: `Добро пожаловать в ${team.name}!`,
        });
      } else {
        toast({
          variant: "destructive",
      ...
      <div className="space-y-6 opacity-0 animate-fade-in-up">
        <Card className="overflow-hidden">
          <div className="relative h-48 sm:h-64">
            <Image
              src="https://placehold.co/2560x720.png"
              alt={`${team.name} banner`}
              fill
              className="object-cover"
              data-ai-hint="sports team banner"
            />
            ...
            <div className="absolute bottom-6 left-6 flex items-end gap-4">
              ...
              <div>
                <h1 className="font-headline text-4xl font-bold text-white shadow-lg">
                  {team.name}
                </h1>
          ...
          <CardHeader className="flex-row items-center justify-between border-t p-4">
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold">Ранг: #{team.rank}</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="h-4 w-4 text-muted-foreground" />{" "}
                <span className="font-semibold">
                  {team.membersCount}/11 игроков
                </span>
              </div>
              <div className="flex items-center gap-2">
              ...
              {homePlayground && (
                <div className="flex items-center gap-2">
                  ...
                  <Link
                    href={`/playgrounds/${homePlayground.id}`}
        ...
        <Tabs defaultValue="overview">
          ...
          <TabsContent value="overview" className="mt-4">
            <TeamOverviewDashboard
              team={team}
              upcomingMatch={dashboardData?.upcomingMatch || null}
