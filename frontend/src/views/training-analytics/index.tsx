...
export function TrainingAnalyticsPage() {
  ...
  const { trainingMetrics, volumeByMuscleGroupData } =
    ...
    <div className="space-y-6 opacity-0 animate-fade-in-up">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Отслеживайте свой прогресс, анализируйте результаты и достигайте новых
          высот.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          ...
          value={trainingMetrics.monthlyVolume}
          icon={Dumbbell}
        />
        <StatCard
          title="Тренировочный стрик"
          value={trainingMetrics.workoutStreak}
          icon={Flame}
        />
        <StatCard
          title="Любимое упражнение"
          value={trainingMetrics.favoriteExercise}
          icon={Star}
        />
        <StatCard
          title="Всего тренировок"
          value={String(trainingMetrics.totalWorkouts)}
          icon={Activity}
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <BarChart3 /> Тренировочный объем по группам мышц
            </CardTitle>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Изменение вашего веса на основе данных из замеров (кг)
            </CardDescription>
          </CardHeader>
          <CardContent>
