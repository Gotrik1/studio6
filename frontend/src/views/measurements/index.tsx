...
const metricOptions: {
  value: keyof Omit<Measurement, "id" | "date">;
  label: string;
}[] = [
...
export function MeasurementsPage() {
  ...
  const [selectedMetric, setSelectedMetric] =
    useState<keyof Omit<Measurement, "id" | "date">>("weight");
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Отслеживайте изменения веса, жира и объемов для максимального
              контроля над прогрессом.
            </p>
          </div>
          ...
          <CardHeader>
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setSelectedMetric(
                    value as keyof Omit<Measurement, "id" | "date">,
                  )
                }
              >
