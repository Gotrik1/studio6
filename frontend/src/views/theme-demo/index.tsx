    ...
    <div className="space-y-6 opacity-0 animate-fade-in-up">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Эта страница демонстрирует различные компоненты пользовательского
          интерфейса с текущей темой и акцентным цветом.
        </p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Alert variant="destructive">
                ...
                <AlertDescription>Это уведомление об ошибке.</AlertDescription>
              </Alert>
            </CardContent>
          </Card>
        </div>
