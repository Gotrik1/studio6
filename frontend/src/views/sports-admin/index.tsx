...
import { getSports, createSport, deleteSport } from '@/entities/sport/api/sports';
...
export function SportsAdminPage() {
    ...
    const [newSport, setNewSport] = useState<{ name: string, category: 'Командный' | 'Некомандный' | 'Киберспорт', icon: string }>({ name: '', category: 'Командный', icon: 'Users' });
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                         ...
                         <div className="space-y-2">
                            ...
                            <Select 
                                ...
                                onValueChange={(value: 'Командный' | 'Некомандный' | 'Киберспорт') => setNewSport(prev => ({...prev, category: value}))}
                            >
                        ...
                        <Button className="w-full" onClick={handleAddSport} disabled={isSubmitting}>
