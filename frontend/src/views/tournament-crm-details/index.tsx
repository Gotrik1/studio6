...
export function TournamentCrmDetailsPage({
  tournamentId,
}: TournamentCrmDetailsPageProps) {
        ...
        <TabsContent value="rules" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Здесь вы можете подробно описать все правила и условия
                проведения турнира. Используйте Markdown для форматирования,
                если необходимо.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="bracket" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Визуальное представление турнирной сетки. Функции редактирования
