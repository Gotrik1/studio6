...
**Версия:** 2.0 | **Дата последнего обновления:** 31.07.2024
...
Планируется разработка полноценного RESTful API на Node.js (NestJS) с базой данных PostgreSQL. Вся документация по API будет вестись в формате OpenAPI (Swagger). Подробности в [Backend Roadmap](/documents/backend-roadmap).
