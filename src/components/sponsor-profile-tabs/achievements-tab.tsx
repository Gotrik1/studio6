...
import type { sponsorAchievements as SponsorAchievementsArray } from "@/lib/mock-data/sponsor-profile";
...
export function SponsorAchievementsTab({ achievements }: SponsorAchievementsTabProps) {
    return (
        <Card>
