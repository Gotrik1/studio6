...
import type { managerUser, managerAchievements } from "@/lib/mock-data/manager-profile";
import { Skeleton } from './ui/skeleton';

const ManagerStatsTab = dynamic(() => import('@/components/manager-profile-tabs/stats-tab').then(mod => mod.ManagerStatsTab), {
...
const ManagerAchievementsTab = dynamic(() => import('@/components/manager-profile-tabs/achievements-tab').then(mod => mod.ManagerAchievementsTab), {
