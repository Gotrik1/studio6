...
const OrganizerStatsTab = dynamic(() => import('@/components/organizer-profile-tabs/stats-tab').then(mod => mod.OrganizerStatsTab), {
...
const OrganizerAchievementsTab = dynamic(() => import('@/components/organizer-profile-tabs/achievements-tab').then(mod => mod.OrganizerAchievementsTab), {
