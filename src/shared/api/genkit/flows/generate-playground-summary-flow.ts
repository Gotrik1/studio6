...
export async function generatePlaygroundSummary(input: GeneratePlaygroundSummaryInput): Promise<GeneratePlaygroundSummaryOutput> {
  return generatePlaygroundSummaryFlow(input);
}

const prompt = ai.definePrompt({
  name: 'generatePlaygroundSummaryPrompt',
...
const generatePlaygroundSummaryFlow = ai.defineFlow(
  {
    name: 'generatePlaygroundSummaryFlow',
