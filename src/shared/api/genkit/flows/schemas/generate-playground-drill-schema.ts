...
export const GeneratePlaygroundDrillInputSchema = z.object({
  userWeakness: z.string().describe('A specific weakness of the player, e.g., "low 3-point percentage" or "poor ball control".'),
  playgroundType: z.string().describe('The type of sport the playground is for (e.g., "Футбол", "Баскетбол").'),
});
export type GeneratePlaygroundDrillInput = z.infer<typeof GeneratePlaygroundDrillInputSchema>;
