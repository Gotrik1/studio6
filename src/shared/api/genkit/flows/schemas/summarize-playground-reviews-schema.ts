...
export const SummarizePlaygroundReviewsInputSchema = z.object({
  reviews: z.array(z.string()).describe("An array of user review texts about a playground."),
});
export type SummarizePlaygroundReviewsInput = z.infer<typeof SummarizePlaygroundReviewsInputSchema>;
