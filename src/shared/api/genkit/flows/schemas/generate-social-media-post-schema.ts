...
export const GenerateSocialMediaPostInputSchema = z.object({
  ...
  postType: z.enum(['match_announcement', 'player_highlight', 'general_update']).describe("The type of post to generate."),
  context: z.string().describe("Context for the post, e.g., 'Upcoming match against Team Rival at 8 PM' or 'Highlighting our star player, Sonic, for their amazing performance.'"),
});
