...
export const availableJudges = [
    { id: 'judge-3', name: 'Алексей Петров', role: 'Судья', avatar: 'https://placehold.co/100x100.png' },
    { id: 'judge-4', name: 'Ольга Михайлова', role: 'Судья', avatar: 'https://placehold.co/100x100.png' },
];
