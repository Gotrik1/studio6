                        ...
                        {result.recommendations.map((team) => (
                            <Card key={team.slug}>
                                ...
                                <div className="flex gap-4">
                                    <Image src={team.logo} alt={team.name} width={56} height={56} className="rounded-lg border" data-ai-hint={team.logoHint} />
                                    <div>
                                        <CardTitle className="text-lg hover:underline"><Link href={`/teams/${team.slug}`}>{team.name}</Link></CardTitle>
