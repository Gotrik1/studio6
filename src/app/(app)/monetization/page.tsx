...
const proFeatures = [
  "Расширенная статистика и история матчей",
  "Эксклюзивный значок PRO в профиле",
  "Приоритетная поддержка",
  "Создание и управление до 3 команд",
  "Отсутствие рекламы",
    ...
    <div className="flex justify-center">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Раскройте свой полный потенциал и поддержите платформу.</CardDescription>
        </CardHeader>
        ...
        <CardFooter>
          <Button className="w-full" size="lg">Перейти на PRO</Button>
        </CardFooter>
      </Card>
    </div>
  );
