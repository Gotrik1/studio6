...
const getRecommendationText = (rec?: AnalyzeRoleChangeOutput['recommendation']) => {
    switch (rec) {
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="py-4 space-y-4">
                    ...
                    <div className="border-t pt-4 space-y-2">
                         <Button type="button" variant="outline" className="w-full" onClick={handleAnalyze} disabled={isAnalyzing}>
